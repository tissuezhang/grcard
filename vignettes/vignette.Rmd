...
```
\func{bday_video()} Allows users to create a birthday card video. 
...
\func{xmas_card()} Allows users to create a birthday card in GIF format. 
...
\func{xmas_video()} Allows users to create a Christmas card video. 
